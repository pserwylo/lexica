...
public class FullUsGbTrieTest extends TrieTest {
    ...
    private static final String[] WORDS = new String[]{"quod", "ono", "son", "soon", "sod", "soda", "sad", "sadi", "sag", "sago", "nod", "nodi", "nog", "ado", "ago", "agon", "dos", "don", "dog", "dag", "dago", "dagos", "dug", "dig", "goo", "goon", "gos", "goa", "goad", "gov", "god", "gas", "gad", "guv", "guidon", "gid", "pud", "pug", "udo", "updo",};
